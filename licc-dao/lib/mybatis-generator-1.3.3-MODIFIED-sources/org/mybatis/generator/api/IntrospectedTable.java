...
public abstract class IntrospectedTable {
    ...
    public String getPageStatementId() {
        return tableConfiguration.getPageStatementId();
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        setUpdateByPrimaryKeyWithBLOBsStatementId("updateWithBLOBs"); //$NON-NLS-1$
    ...
    private void setPageId(String page) {
        internalAttributes.put(InternalAttribute.PAGE_ID, page);
    }
