...
public class IbatorConfigurationParser {
    ...
    private void parseTable(Context context, Node node) {
        ...
        String enablePage = attributes.getProperty("enablePage"); //$NON-NLS-1$
        String pageId = attributes.getProperty("pageId");
        ...
        if (stringHasValue(enablePage)) {
            tc.setPageEnabled(isTrue(enablePage));
        }
